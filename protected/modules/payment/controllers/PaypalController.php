...
class PaypalController extends TController
{
    ...
    public function actionPaynow($id = null)
    {
        ...
        $transaction->state_id = Transaction::PAYMENT_STATUS_PENDING;
        if ($transaction->save()) {
    ...
    public function actionSuccess($id)
    {
        ...
        if (! empty($paymentTransaction)) {
           ...
           // \Yii::error(VarDumper::dump($transactionDetail), 'transactionDetail');
            ...
            if (isset($sendData['request']['success'])) {
                ...
                if ($query) {
                    $successUrl .= "&transactionId=$paymentTransaction->model_id ";
                } else {
                    $successUrl .= "?transactionId=$paymentTransaction->model_id ";
                }
            }
        ...
        \Yii::$app->session->setFlash('error', \Yii::t('app','Transaction not complete.'));
    }
