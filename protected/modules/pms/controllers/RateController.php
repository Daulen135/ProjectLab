...
use app\modules\pms\models\search\Rate as RateSearch;
 ...
 */
class RateController extends TController
{
    ...
    public function actionAdd($id)
    {
        ...
        $model->state_id = Rate::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Rate model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Rate Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
