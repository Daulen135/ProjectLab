...
use app\modules\pms\models\search\Milestone as MilestoneSearch;
 ...
 */
class MilestoneController extends TController
{
  public function behaviors() {
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Milestone::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Milestone model.
     * If update is successful, the browser will be redirected to the 'view' page.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Truncate an existing Milestone model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Milestone Cleared !!!');
