...
/**
 * This is the model class for table "tbl_pms_opex_budget".
 *
 * @property integer $id
 ...
 */
class OpexBudget extends \app\components\TActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'amount' => Yii::t('app', 'Total Project Expenses'),
            'expense' => Yii::t('app', 'General Expenses'),
            'payroll' => Yii::t('app', 'Payroll'),
            'item_name' => Yii::t('app', 'Others'),
    ...
    public static function addData($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $model->item_name = isset($item['item_name']) ? $item['item_name'] : $faker->name;
    ...
    {
       $total = $this->expense + $this->payroll + $this->item_name;
       return $this->project->currency . $total;
    }
}
