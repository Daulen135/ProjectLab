...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Opex Budgets'), 'url' => ['index']];
$this->params['breadcrumbs'][] = (string)$model;
?>
<div class="wrapper">
   <div class="card">
      <div class="opex-budget-view card-body">
   ...
   <div class="card">
      <div class="card-body">
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'opex-budget-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
   </div>
