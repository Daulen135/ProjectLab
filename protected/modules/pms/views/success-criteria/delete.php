...
$this->params['breadcrumbs'][] = [
    'label' => Yii::t('app', 'Success Criterias'),
    'url' => [
        'index'
    ]
];
...
<div class="wrapper">
	<div class="card">
		<div class="success-criteria-view card-body">
...
$form = TActiveForm::begin([
        ...
        ?>
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'success-criteria-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
	</div>
	<div class="card">
		<div class="card-body">
			<div class="success-criteria-panel">
            <?php
