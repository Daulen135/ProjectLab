...
<div class="card-body">
   ...
   ?>
                  <?php echo $form->field($model, 'project_id')->dropDownList($model->getProjectOptions(), ['prompt' => '']) ?>
                              <?php echo $form->field($model, 'milestone_id')->dropDownList($model->getMilestoneOptions(), ['prompt' => '']) ?>
      ...
      <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['id'=> 'capex-budget-form-submit','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
   </div>
   <?php TActiveForm::end(); ?>
</div>