							...
							<tr>
								<td style="padding:20px;">
									<table style="border-collapse: collapse;" cellpadding="0" width="100%">
										<tr>
											<td style="color: #fff;text-align: center;background: #ed7d31;padding: 10px 0;"><h2 style="margin: 0;font-size: 18px;">Risk Matrix</h2></td>
										</tr>
										<tr>
											<td style="vertical-align: top;">
												<table cellspacing="0" cellpadding="0" style="background: #fff;width: 100%;table-layout: fixed;margin:30px 0 0 0">
													<thead>
														<tr>
															<th style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;color:#fff;text-align: left;background: #004660;">Risk description</th>
															<th style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;color:#fff;text-align: left;background: #004660;">Likelihood</th>
															<th style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;color:#fff;text-align: left;background: #004660;">Conseqense</th>
															<th style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;color:#fff;text-align: left;background: #004660;">Risk Status</th>
														</tr>
													</thead>
													<tbody>
														<?php
            ...
            foreach ($data as $value) {
                ?>
															<tr>
																...
																<td style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;"><?=$value->getSeverity();?></td>
																<td style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;"><?=$value->getImpact();?></td>
																<td style="border-bottom: 1px solid #bdc8d7;padding: 12px 10px;"><?=$value->getState();?></td>
															</tr>
															<?php
            }
            ?>
