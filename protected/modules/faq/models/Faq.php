 ...
 */
class Faq extends \app\components\TActiveRecord
{
    ...
    {
        return '/faq/' . parent::getControllerID();
    }
    ...
    public static function addTestData($count = 1)
    {
        ...
        for ($i = 0; $i < $count; $i ++) {
            ...
            $model->question = $faker->text(10);
            $model->answer = $faker->text(10);
    ...
    public static function addData($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $model->question = isset($item['question']) ? $item['question'] : $faker->text(10);

            $model->answer = isset($item['answer']) ? $item['answer'] : $faker->text(10);
