 ...
 * @since 2.0
 */
class TAuthAction extends Action {
	/**
	 *
	 * @var string name of the auth client collection application component.
	 *      It should point to [[Collection]] instance.
	 */
	public $clientCollection = 'app\modules\social\components\TCollection';
	/**
	 *
	...
	public function run() {
		if (! empty ( $_GET [$this->clientIdGetParamName] )) {
			...
			$authChoice = new TAuthChoice ();
			$collection->setClients ( $authChoice->dbClients () );
	...
	/**
	 * Redirect to the URL.
	 * If URL is null, [[successUrl]] will be used.
	 *
	 * @param string $url
	 *        	URL to redirect.
