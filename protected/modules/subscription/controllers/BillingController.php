...
use app\modules\subscription\models\search\Billing as BillingSearch;
 ...
 */
class BillingController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Billing::STATE_ACTIVE;
    ...
    /**
     * Clone an existing Billing model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    public function actionClone($id)
    {
        ...
        // $model->id = $old->id;
        $model->subscription_id = $old->subscription_id;
    ...
    /**
     * Truncate an existing Billing model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Billing Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
    ...
    public function actionMass($action = 'delete')
    {
        ...
        $response['status'] = 'NOK';
        $status = Billing::massDelete('delete');
        if ($status == true) {
            $response['status'] = 'OK';
        }
        return $response;
            ...
            case 'view':
                {
                    ...
                    if ($model != null) {
                        $this->menu['clone'] = array(
                            'label' => '<span class="glyphicon glyphicon-copy">' . Yii::t('app', 'Clone') . '</span>',
