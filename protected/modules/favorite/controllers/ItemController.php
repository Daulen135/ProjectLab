...
use app\modules\company\models\search\Company as CompanySearch;
use app\modules\favorite\models\Item;
use app\modules\favorite\models\search\Item as FavoriteItemSearch;
use app\modules\inventory\models\search\Item as ItemSearch;
use app\modules\pms\models\search\Agreement as AgreementSearch;
use app\modules\pms\models\search\Client as ClientSearch;
use app\modules\pms\models\search\Invoice as InvoiceSearch;
use app\modules\pms\models\search\Project as ProjectSearch;
use app\modules\pms\models\search\Task as TaskSearch;
use app\modules\review\models\search\Goal as GoalSearch;
use app\modules\training\models\search\Session as SessionSearch;
use app\modules\wiki\models\search\Document as DocumentSearch;
use Yii;
