...
use app\modules\favorite\models\search\QuickLink as QuickLinkSearch;
use Yii;
 ...
 */
class QuickLinkController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = QuickLink::STATE_ACTIVE;
    ...
    /**
     * Clone an existing QuickLink model.
     * If update is successful, the browser will be redirected to the 'view' page.
     *
     * @param integer $id
     * @return mixed
    ...
    public function actionClone($id)
    {
        ...
        $model->explore_option = $old->explore_option;
    ...
    /**
     * Deletes an existing QuickLink model.
    ...
    /**
     * Truncate an existing QuickLink model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'QuickLink Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
    ...
    public function actionMass($action = 'delete')
    {
        ...
        $status = QuickLink::massDelete('delete');
        if ($status == true) {
            $response['status'] = 'OK';
        }
        return $response;
