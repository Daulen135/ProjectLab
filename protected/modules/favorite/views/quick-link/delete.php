...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Favorites'), 'url' => ['/favorite']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Quick Links'), 'url' => ['index']];
...
<div class="text-center">
		...
		<div
			class="quick-link-view card-body">
...
?>
	 ...
	 <div class="form-group">
		<div
			class="col-md-12 mt-2 text-right">
