...
use app\modules\feature\models\search\Update as UpdateSearch;
use Yii;
 ...
 */
class UpdateController extends TController
{
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Update::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Update model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Update Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
