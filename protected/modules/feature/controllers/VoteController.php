...
use app\modules\feature\models\search\Vote as VoteSearch;
use Yii;
 ...
 */
class VoteController extends TController
{
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Vote::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Vote model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Vote Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
