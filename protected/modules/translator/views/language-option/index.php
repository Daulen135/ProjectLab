...
$this->params['breadcrumbs'][] = [
    'label' => Yii::t('app', 'Language Options'),
    'url' => [
        'index'
    ]
];
...
<?=\app\components\PageHeader::widget(['title' => Yii::t('app', 'Language Options')]);?>
    ...
    echo $form->field($model, 'language_code')->dropDownList($model->getLanguageCode(), [
        'maxlength' => 255
    ])?>
