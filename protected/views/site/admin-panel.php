...
<div class="wrapper">
	...
	<div class="page-head">
		...
		<br> <span class="sub-title"><?= Yii::t('app', 'Welcome to your')?> <b><?php echo User::getRoleOptions(Yii::$app->user->identity->role_id);?></b>
			<?= Yii::t('app', 'dashboard')?>
		</span>
				...
				<div class="col-lg-3 col-sm-6">
					<section class="panel purple">
						...
						<?php  echo  EmailAccount::find()->count();?>
							...
							<p><?= Yii::t('app', 'Total EmailAccount')?></p>
						</div>
					</section>
				</div>
