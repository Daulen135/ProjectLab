...
?>
         <div class="col-md-6">
                  <?php /*echo $form->field($model, 'from_email')->textInput(['maxlength' => 128]) */ ?>
                              ...
                              <?php 
/*
                                * echo $form->field($model, 'date_published')->widget(yii\jui\DatePicker::class,
                                * [
                            ...
                            ?>
                              <?php 
/*
                                * echo $form->field($model, 'last_attempt')->widget(yii\jui\DatePicker::class,
                                * [
                                * //'dateFormat' => 'php:Y-m-d',
                                * 'options' => [ 'class' => 'form-control' ],
                                * 'clientOptions' =>
                            ...
                            ?>
                              <?php 
/*
                                * echo $form->field($model, 'date_sent')->widget(yii\jui\DatePicker::class,
                                * [
                                * //'dateFormat' => 'php:Y-m-d',
                                * 'options' => [ 'class' => 'form-control' ],
                                * 'clientOptions' =>
